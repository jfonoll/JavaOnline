...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Presencial 1 deprecated: Total de " + horestreballades1 + " hores treballades de : " + treballadorPresencial1.getCognom() + " a " + treballadorPresencial1.getPreuhora() + "eur/hora , son " + treballadorPresencial1.calcularsou(20)+ " euros, dels cuals " + TreballadorPresencial.getGasolina()  +" son de combustible");
